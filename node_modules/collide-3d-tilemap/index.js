module.exports = function(field, tilesize, dimensions, offset) {
  ...
  function collide(box, vec, oncollision) {
    ...
    function collideaxis(i_axis) {
      ...
      // (Math.floor((leading + vec[i_axis]) / tilesize)) + dir
      // console.log("leading = "+leading);
      // console.log("vec[i_axis] = "+vec[i_axis]);
      ...
      var step = 0
      // console.log("i :: "+i_start+"-"+i_end);
      // console.log("j :: "+j_start+"-"+j_end);
      // console.log("k :: "+k_start+"-"+k_end);
