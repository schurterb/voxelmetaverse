...
proto.tick = function(dt) {
  ...
  if( this.avatar.position.copy ) {
    this.avatar.position.copy(START)
  } else {
    this.avatar.position.x = START.x;
    this.avatar.position.y = START.y;
    this.avatar.position.z = START.z;
  }
  ...
  for(var i = 0, len = pcs.length; i < len; ++i) {
    if(pcs[i] !== this) {
      // console.log("pcs[i] : ",pcs[i]);
      // console.log("this : ",this);
      // console.log("bbox : ",bbox);
      // console.log("world_desired : ",world_desired);
      // console.log("this.resting : ",this.resting);
