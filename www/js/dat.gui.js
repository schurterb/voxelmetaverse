    ...
    dat.GUI = dat.gui.GUI = (function(css, saveDialogueContents, styleSheet, controllerFactory, Controller, BooleanController, FunctionController, NumberControllerBox, NumberControllerSlider, OptionController, ColorController, requestAnimationFrame, CenteredDiv, dom, common) {
        ...
        function add(gui, object, property, params) {
            ...
            if (object[property] === undefined) {
                throw new Error("Object " + object + " has no property "
                    " + property + "
                    "");
            }
        ...
        "<div id="
        dg - save " class="
        dg dialogue ">nn  Here's the new load parameter for your <code>GUI</code>'s constructor:nn  <textarea id="
        dg - new - constructor "></textarea>nn  <div id="
        dg - save - locally ">nn    <input id="
        dg - local - storage " type="
        checkbox "/> Automatically saven    values to <code>localStorage</code> on exit.nn    <div id="
        dg - local - explain ">The values saved to <code>localStorage</code> willn      override those passed to <code>dat.GUI</code>'s constructor. This makes itn      easier to work incrementally, but <code>localStorage</code> is fragile,n      and your friends may not see the same values you do.n      n    </div>n    n  </div>nn</div>",
