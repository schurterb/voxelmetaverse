function voxel_furnace (require, module, exports) {
    'use strict';
    ...
    class FurnaceDialog extends InventoryDialog {
        constructor(game, playerInventory, registry, recipes, blockdata) {
            ...
            const burnIW = new InventoryWindow({
                width: 1,
                registry: registry,
                inventory: burnInventory,
                linkedInventory: playerInventory
            });

            const fuelInventory = new Inventory(1);
            const fuelIW = new InventoryWindow({
                width: 1,
                registry: registry,
            ...
            const resultIW = new InventoryWindow({
