function pin_it(require, module, exports) {
    module.exports = pin
    ...
    function make_pin_for(name, obj) {
        ...
        return (pins[name] = pins[name] || []).push({
            body: body,
            last: -Infinity,
            for_object: obj
        }), pins[name]
    ...
    function pin(item, every, obj, name) {
        ...
        var location = name || stack_holder.stack.split('n').slice(2)[0].replace(/^s+at /g, ''),
