function cube_icon (require, module, exports) {
    'use strict';
...
height: ${s}px;`);
                ...
                if (faceFilters[faceName]) {
                    ...
                    face.style.filter = faceFilters[faceName]; // for future support (note: unsupported in Firefox 27; see https://developer.mozilla.org/en-US/docs/Web/CSS/filter<hashtag>Gecko_notes)
                }
