function voxel_decorative (require, module, exports) {
    'use strict';
    ...
    function DecorativePlugin(game, opts) {
        ...
        this.storageBases = opts.storageBases || {
            iron: 'ingotIron',
            gold: 'ingotIron'
        }; // TODO: refactor, metals? (always require ingots)
    ...
    DecorativePlugin.prototype.enable = function() {
        ...
        registry.registerBlock('stoneBrick', {
            texture: 'stonebrick',
            displayName: 'Stone Bricks',
            hardness: hardness,
            creativeTab: 'decorative'
        });
        registry.registerBlock('stoneBrickCarved', {
            texture: 'stonebrick_carved',
            displayName: 'Carved Stone Bricks',
            hardness: hardness,
            creativeTab: 'decorative'
        });
        registry.registerBlock('stoneBrickCracked', {
            texture: 'stonebrick_cracked',
            displayName: 'Cracked Stone Bricks',
            hardness: hardness,
            creativeTab: 'decorative'
        });
        registry.registerBlock('stoneBrickMossy', {
