function inventory_window (require, module, exports) {
    (function(global) {
        (function() {
            'use strict';
...
`);
                ...
                populateSlotNode(div, itemPile, isSelected) {
                    ...
                    if (!textBox) {
                        ...
                        textBox.setAttribute('style', 'position: absolute; text-shadow: 1px 1px <hashtag>eee, -1px -1px <hashtag>333;');
