function voxel_pumpkin (require, module, exports) {
    'use strict';
    ...
    function PumpkinPlugin(game, opts) {
        ...
        this.textures = [
            ...
            },
            {
                ...
                bottom: 'pumpkin_top',
                left: 'pumpkin_side',
                right: 'pumpkin_face_off'
            },

            // lit
            {
                back: 'pumpkin_face_on',
                front: 'pumpkin_side',
                top: 'pumpkin_top',
                bottom: 'pumpkin_top',
                left: 'pumpkin_side',
    ...
    PumpkinPlugin.prototype.enable = function() {
        ...
        this.registry.registerItem('shears', {
            itemTexture: 'items/shears',
            toolClass: 'shears',
            onUse: this.useShears.bind(this)
        });
        ...
        this.registry.registerItem('lighter', {
            itemTexture: 'items/flint_and_steel',
            toolClass: 'lighter',
            onUse: this.useLighter.bind(this)
        });
    };
