function game_shell_fps_camera (require, module, exports) {
    'use strict';
    ...
    function CameraPlugin(game, opts) {
        ...
        this.camera.lookAt = function(eye, center, up) {
            console.log(eye, center, up);
        }; // TODO: add to basic-camera, as in orbit-camera (https://github.com/hughsk/basic-camera/issues/5)
        ...
        Object.defineProperty(this.player.position, 'x', {
            get: function() {
        ...
        Object.defineProperty(this.player.position, 'y', {
            get: function() {
                return -camera.position[1] - offset;
            },
            set: function(v) {
                camera.position[1] = -v - offset;
            }
        });
        Object.defineProperty(this.player.position, 'z', {
            get: function() {
        ...
        Object.defineProperty(this.player.rotation, 'x', {
            get: function() {
        ...
        Object.defineProperty(this.player.rotation, 'y', {
            get: function() {
        ...
        Object.defineProperty(this.player.rotation, 'z', {
            get: function() {
    ...
    CameraPlugin.prototype.enable = function() {
        ...
        this.pointerStream = new PointerStream({
            shell: this.shell
        });
