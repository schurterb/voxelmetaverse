function inflate (require, module, exports) {
    'use strict';
    ...
    */
            ...
            for (;;) {
                switch (state.mode) {
                    ...
                    case TABLE:
                        ...
                        bits -= 4;
                        //---//
                        //<hashtag>ifndef PKZIP_BUG_WORKAROUND
                    ...
                    case MATCH:
                        ...
                        if (state.offset > copy) {
                            ...
                            if (copy > state.whave) {
                                ...
                                //<hashtag>ifdef INFLATE_ALLOW_INVALID_DISTANCE_TOOFAR_ARRR
    ...
    function inflateSetDictionary(strm, dictionary) {
        ...
        state.havedict = 1;
        // Tracev((stderr, "inflate:   dictionary setn"));
        return Z_OK;
    }
